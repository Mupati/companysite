        ...
        object: {
          '#slide-artboard-welcome': {
            ...
            callback(element, index) {
              switch (index) {
                case 'initial':
                  $('.creative-title', element).html('Welcome to <br><span>Ek Brand Consult</span>');
                  break;
                case '4500':
                  $('.creative-title', element).html('The Marketing Partner <br>for <span>Smart Businesses</span>');
              }
            },
          },
        },
